...
public class RogiTester {
	...
	public static void main(String[] args) {
		...
		RogiDTO dto1 = new RogiDTO(1, "abc", 20, "fever", true);
		RogiDTO dto2 = new RogiDTO(2, "def", 23, "cold", true);
		RogiDTO dto3 = new RogiDTO(3, "hij", 22, "cancer", false);
		RogiDTO dto4 = new RogiDTO(4, "klm", 21, "corona", true);
		RogiDTO dto5 = new RogiDTO(5, "xyz", 24, "small pox", true);
